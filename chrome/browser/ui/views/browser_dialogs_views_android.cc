...
ExtensionInstallPrompt::GetDefaultShowDialogCallback() {
  return ExtensionInstallPrompt::ShowDialogCallback();//ExtensionInstallPrompt::GetViewsShowDialogCallback();
}
...
task_manager::TaskManagerTableModel* ShowTaskManager(Browser* browser) {
  return NULL;//task_manager::TaskManagerView::Show(browser);
}
